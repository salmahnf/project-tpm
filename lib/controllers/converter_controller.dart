...
//   // Simulasi timezone offset (dalam jam dari UTC)
...
//       // Parse input datetime (format: dd/MM/yyyy HH:mm)
...
//       DateTime inputDateTime = DateTime(year, month, day, hour, minute);

//       // Get timezone offsets
//       int fromOffset = _timezoneOffsets[fromTimezone] ?? 0;
//       int toOffset = _timezoneOffsets[toTimezone] ?? 0;

//       // Konversi ke UTC terlebih dahulu
//       DateTime utcDateTime =
//           inputDateTime.subtract(Duration(hours: fromOffset));

//       // Lalu konversi ke target timezone
//       DateTime targetDateTime = utcDateTime.add(Duration(hours: toOffset));

//       // Format hasil
//       String formattedDate =
//           '${targetDateTime.day.toString().padLeft(2, '0')}/${targetDateTime.month.toString().padLeft(2, '0')}/${targetDateTime.year}';
//       String formattedTime =
//           '${targetDateTime.hour.toString().padLeft(2, '0')}:${targetDateTime.minute.toString().padLeft(2, '0')}';

//       return '$formattedDate $formattedTime ($toTimezone)';
//     } catch (e) {
//       throw Exception('Failed to convert timezone: $e');
//     }
//   }
