// views/home_screen.dart (Updated)
...
import 'convert_screen.dart'; // Import ConvertScreen
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _getCurrentPage() {
    switch (_currentIndex) {
      ...
      case 2:
        return ConvertScreen(); // Gunakan ConvertScreen yang sudah dibuat
      case 3:
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: _currentIndex == 2
          ? null
          : AppBar(
              // Hide AppBar untuk ConvertScreen
